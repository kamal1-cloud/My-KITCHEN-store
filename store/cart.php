...
<?php 
    ...
    if($row_count > 0){
        ...
        $add_query = "INSERT INTO cart(client_id,item_id,item_name,item_price,item_img,item_date) VALUES ('$client_id','$Item_ID','$item_title','$item_price','$item_image',now())";
                  ...
                  ?>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/<?php $item_img ?>" alt="">
                                        <h5><?php  $item_name ?></h5>
                                    </td>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="pro-qty">
                                                <input type="text" value="<?php  $item_quantity  ?>">
                                            </div>
                                        </div>
                                    </td>
